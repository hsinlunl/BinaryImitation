...
ggplot(df_time, aes(x = Simulation)) +
  ...
  labs(title = "Cumulative Proportion over Simulations (Model A without an odd cycle)",
       x = "Simulation Number",
...
write.csv(df_time, "cumulative_proportions_modelANoOdd.csv", row.names = FALSE)
